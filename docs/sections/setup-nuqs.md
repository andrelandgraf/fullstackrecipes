...
[nuqs](https://nuqs.dev) syncs React state to URL query parameters, enabling shareable links for filters, search queries, and modal dialogs. When users return to a page via browser back/forward, their UI state is preserved.
